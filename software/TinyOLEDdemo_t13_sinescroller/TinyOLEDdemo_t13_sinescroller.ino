// ===================================================================================
// Project:   TinyOLED Demo - Sine Wave Scroller
// Version:   v1.0
// Year:      2021
...
// Description:
// ------------
// Retro-style sine wave animated text scroller.
//
// References:
// -----------
...
const char Message[] PROGMEM =
  "                     ATTINY13 LOVES OLED - AND SINE WAVES, TOO! "
  "FOR MORE INFORMATION VISIT GITHUB.COM/WAGIMINATOR.   "
  "8-BIT POWER RULEZ!";
...
int main(void) {
  ...
  while(1) {                                  // loop until forever                         
    ...
    for(uint8_t i=22; i; i--) {               // print 22 characters
      OLED_plotChar(pgm_read_byte(&Message[p])); // read and print one character
